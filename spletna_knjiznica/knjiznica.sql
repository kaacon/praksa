...
--
-- Gostitelj: 127.0.0.1
-- Čas nastanka: 24. apr 2023 ob 17.53
...
CREATE TABLE `knjiga` (
  ...
  `avtor` varchar(45) COLLATE utf8_slovenian_ci DEFAULT NULL,
  `leto_izdaje` varchar(45) COLLATE utf8_slovenian_ci DEFAULT NULL
...
CREATE TABLE `uporabniki` (
  `id` int(10) NOT NULL,
  `uporabnisko_ime` varchar(45) COLLATE utf8_slovenian_ci DEFAULT NULL,
  `geslo` varchar(45) COLLATE utf8_slovenian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_slovenian_ci;
...
--
ALTER TABLE `knjiga`
  MODIFY `id_knjiga` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
